...
public typealias ViewControllerFactory = (_ url: URLConvertible, _ values: [AnyHashable: Any], _ context: Any?) -> UIViewController?
public typealias URLOpenHandlerFactory = (_ url: URLConvertible, _ values: [AnyHashable: Any], _ context: Any?) -> Bool
